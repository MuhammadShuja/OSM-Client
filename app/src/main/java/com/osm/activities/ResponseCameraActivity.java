...
public class ResponseCameraActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setCameraDisplayOrientation(ResponseCameraActivity.this, mCameraFace, mCamera);
                try {
                    mCamera.setPreviewDisplay(mSurfaceHolder);
                } catch (IOException e) {
                    e.printStackTrace();
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ResponseCameraActivity.this, MergerResponseActivity.class));
            }
        });
    }
    ...
    Camera.PictureCallback mPictureCallback_JPG = new Camera.PictureCallback(){
        ...
        public void onPictureTaken(byte[] arg0, Camera arg1) {
            ...
            CropModel.responseImage = Bitmap.createBitmap(bitmapPicture, 0, 0, bitmapPicture.getWidth(), bitmapPicture.getHeight(), null, true);

            startActivity(new Intent(ResponseCameraActivity.this, ResponseAdjustActivity.class));
        }};
